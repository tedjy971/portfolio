  ...
  const experiences = [
    {
      ...
      company: 'Kernix',
      period: 'Actuel',
      description: 'Direction technique des projets web, management d\'équipe et implémentation des meilleures pratiques de développement.'
    },
    {
      title: 'Développeur Back-end',
      company: 'Kernix',
      period: 'Précédemment',
      description: 'Développement d\'applications web robustes avec PHP, Symfony et API REST.'
    },
    {
      title: 'Master Tech Lead',
      company: 'Formation',
      period: 'En cours',
      description: 'Formation en alternance avec spécialisation en direction technique des projets web.'
    },
    {
      title: 'Bachelor Web',
      company: 'Formation',
      period: 'Précédemment',
      description: 'Formation approfondie en développement web et technologies modernes.'
    },
    {
      title: 'Licence Data Analyste',
      company: 'Formation',
      period: 'Précédemment',
      description: 'Formation en analyse de données et manipulation d\'informations complexes.'
    },
    {
      title: 'BTS SNIR',
      company: 'Formation',
      period: 'Précédemment',
      description: 'Systèmes Numériques Informatique et Réseaux - Formation technique en informatique et réseaux.'
    }
  ];
  ...
  const interests = [
    {
      title: 'Musculation',
      icon: '💪',
      description: 'Passionné de musculation et d\'entraînement physique. La discipline et la persévérance du sport sont des valeurs que j\'applique en développement.'
    },
    {
      title: 'DevOps',
      icon: '⚙️',
      description: 'Intéressé par les pratiques DevOps, l\'automatisation des déploiements et l\'infrastructure as code.'
    },
    {
      title: 'Domotique',
      icon: '🏠',
      description: 'Création de solutions domotiques pour automatiser et optimiser mon environnement quotidien.'
    },
    {
      title: 'Développement Web',
      icon: '💻',
      description: 'Veille technologique constante pour rester à la pointe des dernières technologies web et mobiles.'
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Développeur web passionné spécialisé dans les technologies back-end comme PHP et Symfony,
              tout en maîtrisant React et Next.js pour le front-end. Actuellement Tech Lead chez Kernix,
              je combine expertise technique et vision stratégique pour mener des projets web innovants.
            </motion.p>
